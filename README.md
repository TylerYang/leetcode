...
* 30.  Substring with Concatenation of All Words (4) Failed
...
* 60.  Permutation Sequence (3) * failed
* 61.  Rotate List (1)
* 62.  Unique Paths (1)
* 63.  Unique PathsII (1)
...
* 74.  Search a 2D Matrix (3) * (lgn solution)
* 75.  Sort Colors (2)
...
* 115. Distinct Subsequences (5) * (Dynamic Programming) Failed
